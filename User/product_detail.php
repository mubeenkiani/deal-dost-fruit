...
$id = intval($_GET['id']);
$query = "SELECT * FROM `product_info` WHERE Id = $id LIMIT 1";
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="border rounded">
                                <img src="../Admin/<?php echo $product['Thumbnail']; ?>" class="img-fluid rounded" alt="Image">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 mt-4">
                            <nav>
                                <div class="nav nav-tabs mb-3">
                                    <button class="nav-link active border-white border-bottom-0" data-bs-toggle="tab" data-bs-target="#desc">Description</button>
                                    <button class="nav-link border-white border-bottom-0" data-bs-toggle="tab" data-bs-target="#reviews">Reviews</button>
                                </div>
                            </nav>
