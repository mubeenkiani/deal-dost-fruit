<?php 
  ...
  if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO `faqs`(`Question`, `Answer`, `Status`) VALUES ('$question','$answer','$status')";
        ...
        <div class="content-wrapper">
          <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row mb-4">
              <div class="col-md">
                <div class="card">
                  <h5 class="card-header">Add F.A.Qs</h5>
                  <div class="card-body">
                      ...
                      <div class="form-floating form-floating-outline mb-4 col-6">
                        ...
                        <div class="form-floating form-floating-outline mb-4 col-6">
                          <select class="form-select" id="status" name="status" required>
                            ...
                            <option value="return">Order and Returns</option>
