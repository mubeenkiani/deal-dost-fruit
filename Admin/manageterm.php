...
<!-- Product List Table -->
<div class="card">
  <h5 class="card-header">Term & Condition</h5>
    ...
    <table class="table table-hover">
      ...
      <?php
        ...
        if (mysqli_num_rows($run)>0) {
          while ($row = mysqli_fetch_assoc($run)) {
            $id = $row['Id'];
            $data = base64_decode($row['Term&Condition']);
       ?>
      <tbody class="table-border-bottom-0">
        <tr>
          ...
          <td>
            <div>
              <a class="" href="editterm.php?Id=<?php echo $id ?>"><i class="mdi mdi-pencil-outline me-1"></i></a>
              <a onclick="return confirm('Are You Sure')" href="deleteterm.php?Id=<?php echo $id ?>"><i class="mdi mdi-trash-can-outline me-1 text-danger"></i></a>
            </div>
          </td>
        </tr>
      </tbody>
