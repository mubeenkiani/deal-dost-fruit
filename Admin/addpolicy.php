<?php 
  ...
  if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO `policy`(`Privacy_Policy`) VALUES ('$data')";
    $run = mysqli_query($connect,$query);

    if (!$run) {
      $alert = "<div class'alert alert-danger'>Policy not Added</div>";
    } else {
      header("location:managepolicy.php");
      $alert = "<div class'alert alert-success'>Policy Added</div>";
    }
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
          <?php echo $alert ?>
          <textarea class="form-control mb-4" rows="10" id="example" name="editor"></textarea>
          <div>
