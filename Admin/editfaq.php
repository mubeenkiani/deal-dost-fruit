...
<div class="row mb-4">
  <div class="col-md">
    <div class="card">
      <h5 class="card-header">Update F.A.Qs</h5>
      <div class="card-body">
        <form class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
          <?php echo $msge ?>
          <div class="row container">
          <div class="form-floating form-floating-outline mb-4 col-6">
              <input type="text" class="form-control" id="Question" placeholder="Question" name="question" value="<?php echo $oldquestion ?>" />
              <label for="Question">Question</label>
              <div class="invalid-feedback"> Please enter Question. </div>
            </div>
            <div class="form-floating form-floating-outline mb-4 col-6">
              <input type="text" class="form-control" id="Answer" placeholder="Answer" name="answer" value="<?php echo $oldanswer ?>" />
