    ...
    <table class="table table-hover">
      ...
      <tbody class="table-border-bottom-0">
        <tr>
          ...
          <td>
            <div>
              <a class="" href="editcategory.php?Id=<?php echo $row['Id'] ?>"><i class="mdi mdi-pencil-outline me-1"></i></a>
              <a onclick="return confirm('Are You Sure')" href="deletecategory.php?Id=<?php echo $row['Id'] ?>"><i class="mdi mdi-trash-can-outline me-1 text-danger"></i></a>
            </div>
          </td>
        </tr>
      </tbody>
