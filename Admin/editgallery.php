 ...
 $id = $_GET['Id'];
  ...
  if(isset($_POST['submit'])){
    ...
    $thumbnailpath = "media/gallery/.$thumbnail";
    move_uploaded_file($_FILES['thumbnail']['tmp_name'], $thumbnailpath);
    }
    $query = "UPDATE `product_gallery` SET `Name`='$name',`Thumbnail`='$thumbnailpath' WHERE Id = '$id'";
    $run = mysqli_query($connect,$query);

    if (!$run) {
      $msge = "<div class'alert alert-danger'>Product not Added</div>";
    } else {
    	header("location:managegallery.php");
      $msge = "<div class'alert alert-success'>Product Added</div>";
    }
    
  }
  $sql = "SELECT * FROM `product_gallery` WHERE Id = '$id'";
        ...
        <form class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
          ...
          <div class="form-floating form-floating-outline mb-4 col-7">
            ...
            <div class="form-floating form-floating-outline mb-4 col-6">
              ...
              <label for="thmbnail">Gallery Thumbnail</label>
