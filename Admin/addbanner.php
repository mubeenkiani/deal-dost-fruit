...
$alert = "";
  ...
  if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO `product_banner`(`Status`,`Name`, `Thumbnail`, `Price`, `Discout`) VALUES ('$status','$name','$thumbnailpath','$price','$discount')";
    $run = mysqli_query($connect,$query);

    if (!$run) {
      $alert = "<div class'alert alert-danger'>Banner not Added</div>";
    } else {
      $alert = "<div class'alert alert-success'>Banner Added</div>";
                  ...
                  <div class="card-body">
                    <form class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="row container">
                        ...
                        <div class="form-floating form-floating-outline mb-4 col-6">
                          <input type="number" id="Discount" class="form-control" placeholder="Discount" name="discount"
                            required />
