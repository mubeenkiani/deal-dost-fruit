...
<!-- Mirrored from demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/app-ecommerce-product-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 24 Sep 2023 05:40:11 GMT -->
<head>
    <meta charset="utf-8" />
...
<link rel="stylesheet" href="assets/vendor/libs/select2/select2.css">
    ...
    <!-- Helpers -->
    <script src="assets/vendor/js/helpers.js"></script>    <!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
  ...
  <div class="table-responsive text-nowrap">
    <table class="table table-hover">
      ...
      <?php
        ...
        $sql = "SELECT * FROM `product_banner` ORDER BY Status ASC";
        ...
        // $count = SELECT COUNT(*) FROM `product_info`;
        // $run = mysqli_query($connect,$count);
        // if (mysqli_num_rows($run)>0) {
      ...
      <tbody class="table-border-bottom-0">
        <tr>
          <td><?php echo $i ?></td>
          <td><span class="badge rounded-pill bg-label-<?php echo $msge ?> me-1"><?php echo $row['Status'] ?></span></td>
          <td><?php echo $row['Name'] ?></td>
          <td>$ <?php echo $row['Price'] ?></td>
          <td>$ <?php echo $row['Discout'] ?></td>
          <td width="10%"><img src="<?php echo $row['Thumbnail'] ?>" width="100%"></td>
          <td>
            <div>
              <a class="" href="editbanner.php?Id=<?php echo $row['Id'] ?>"><i class="mdi mdi-pencil-outline me-1"></i></a>
              <a onclick="return confirm('Are You Sure')" href="deletebanner.php?Id=<?php echo $row['Id'] ?>"><i class="mdi mdi-trash-can-outline me-1 text-danger"></i></a>
            </div>
          </td>
        </tr>
      </tbody>
...
<!-- Mirrored from demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/app-ecommerce-product-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 24 Sep 2023 05:40:12 GMT -->
</html>
