<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $query = "UPDATE `product_category` SET `Name`='$name',`Thumbnail`='$thumbnailpath',`Quantity`='$quantity' WHERE Id = '$id'";
    $run = mysqli_query($connect,$query);

    if (!$run) {
      $msge = "<div class'alert alert-danger'>Category not Updated</div>";
    } else {
      header("location:managecategory.php");
      $msge = "<div class'alert alert-success'>Category Updated</div>";
    }
      ...
      <div class="card-body">
        <form class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
          ...
          <div class="form-floating form-floating-outline mb-4 col-8">
              <input type="text" class="form-control" id="categoryname" placeholder="Category Name" name="name" value="<?php echo $oldname ?>" required />
            ...
            <div class="form-floating form-floating-outline mb-4 col-8">
              <input type="number" id="categoryquantity" class="form-control" placeholder="Category Quantity" name="quantity" value="<?php echo $oldquantity ?>"/>
