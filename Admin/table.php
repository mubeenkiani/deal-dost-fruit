...
<!-- Mirrored from demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/tables-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 24 Sep 2023 05:42:41 GMT -->
<head>
    <meta charset="utf-8" />
          ...
          <ul class="menu-sub">
            ...
            <li class="menu-item">
              <a href="manageproduct.php" class="menu-link">
                <div data-i18n="Product list">Manage Product</div>
              </a>
            </li>
          </ul>
        </li>
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="manageorder.php" class="menu-link">
                <div data-i18n="Order list">Manage Order</div>
              </a>
            </li>
          </ul>
        </li>
