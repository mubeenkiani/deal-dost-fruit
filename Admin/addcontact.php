<?php 
  ...
  if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO `contact`(`Address`, `Phone_Number`, `Email`, `Website`, `Facebook`, `Instagram`, `Twitter`, `LinkDin`) VALUES ('$address','$phone','$email','$website','$facebook','$instagram','$twitter','$linkdin')";
                  ...
                  <div class="card-body">
                    <form class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="row container">
                        ...
                        <div class="form-floating form-floating-outline mb-4 col-6">
                          <input type="text" class="form-control" id="Linkdin" placeholder="Linkdin" name="linkdin" />
