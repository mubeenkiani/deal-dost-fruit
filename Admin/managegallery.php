  ...
  <div class="table-responsive text-nowrap">
    <table class="table table-hover">
      ...
      <?php
        ...
        $sql = "SELECT * FROM `product_gallery` ORDER BY Id DESC";
      ...
      <tbody class="table-border-bottom-0">
        <tr>
          ...
          <td>
            <div>
              <a class="" href="editgallery.php?Id=<?php echo $row['Id'] ?>"><i class="mdi mdi-pencil-outline me-1"></i></a>
              <a onclick="return confirm('Are You Sure')" href="deletegallery.php?Id=<?php echo $row['Id'] ?>"><i class="mdi mdi-trash-can-outline me-1 text-danger"></i></a>
            </div>
          </td>
        </tr>
      </tbody>
