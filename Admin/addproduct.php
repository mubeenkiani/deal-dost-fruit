...
$alert ="";
  ...
  if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO `product_info`(`Name`, `Category`, `Price`, `Quantity`, `City`, `Country`, `Brand`, `Freshness`, `Description`, `Thumbnail`, `Image1`, `Image2`, `Image3`, `Image4`) VALUES ('$name','$category','$price','$quantity','$city','$country','$brand','$freshnes','$desciption','$thumbnailpath','$image1path','$image2path','$image3path','$image4path')";
    $run = mysqli_query($connect,$query);

    if (!$run) {
      $alert = "<div class'alert alert-danger'>Product not Added</div>";
    } else {
      $alert = "<div class'alert alert-success'>Product Added</div>";
                  ...
                  <div class="card-body">
                    <form class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="row">
                        ...
                        <div class="form-floating form-floating-outline mb-4 col-6">
                          <input type="number" id="productquantity" class="form-control" placeholder="Product Quantity"
                        ...
                        <div class="form-floating form-floating-outline mb-4 col-6">
                          <select class="form-select" id="country" name="country" required>
                            ...
                            <option value="NewZealannd">New Zealannd</option>
                            <option value="Australia">Australia</option>
                            <option value="Pakiatan">Pakiatan</option>
                          </select>
                          <label class="form-label" for="country">Country</label>
                          <div class="invalid-feedback"> Please select your Country </div>
                        </div>
                        <div class="form-floating form-floating-outline mb-4 col-6">
                          <input type="text" id="productbrand" class="form-control" placeholder="Product Brand"
                            name="brand" required />
                        ...
                        <div class="form-floating form-floating-outline mb-4">
                          <textarea class="form-control h-px-75" id="description" rows="3"
                            placeholder="Product Description" name="desciption" required></textarea>
