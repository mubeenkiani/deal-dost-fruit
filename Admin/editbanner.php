...
$id = $_GET['Id'];
  ...
  if(isset($_POST['submit'])){
    ...
    if($thumbnail == ""){
        ...
        $thumbnailpath = "media/banner/.$thumbnail";
        move_uploaded_file($_FILES['thumbnail']['tmp_name'], $thumbnailpath);
    }
    $query = "UPDATE `product_banner` SET `Status`='$status',`Name`='$name',`Thumbnail`='$thumbnailpath',`Price`='$price',`Discout`='$discount' WHERE Id = '$id'";
    $run = mysqli_query($connect,$query);

    if (!$run) {
    } else {
      header("location:managebanner.php");
      $msge = "<div class'alert alert-success'>Banner Updated</div>";
    }
  }
      ...
      <div class="card-body">
        <form class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
          ...
          <div class="form-floating form-floating-outline mb-4 col-6">
              <input type="text" class="form-control" id="Productname" placeholder="Product Name" name="name" value="<?php echo $oldname ?>"/>
              <label for="Productname">Product Name</label>
              <div class="invalid-feedback"> Please enter Product Name. </div>
            </div>
            <div class="form-floating form-floating-outline mb-4 col-6">
              <input type="number" id="ProductPrice" class="form-control" placeholder="Product Price" name="price" value="<?php echo $oldprice ?>" />
              <label for="ProductPrice">Product Price</label>
              <div class="invalid-feedback"> Please enter Product Price </div>
            </div>
            <div class="form-floating form-floating-outline mb-4 col-6">
              <input type="number" id="Discount" class="form-control" placeholder="Discount" name="discount" value="<?php echo $olddiscount ?>" />
              <label for="Discount">Discount</label>
              <div class="invalid-feedback"> Please enter Discount </div>
            </div>
            <div class="form-floating form-floating-outline mb-4 col-6">
              <select class="form-select" id="status" name="status" value="<?php echo $oldstatus ?>">
                <option value="">Select Status</option>
                <option value="Active" <?php if($oldstatus == "Active"){ echo "selected";}?>>Active</option>
                <option value="Inactive" <?php if($oldstatus == "Inactive"){ echo "selected";}?>>Inactive</option>
              </select>
              <label class="form-label" for="status">Status</label>
              <div class="invalid-feedback"> Please select your Status</div>
            </div>
            <div class="col-6">
              <img src="<?php echo $oldthumbnail ?>" width="70%">
            </div>
            <div class="form-floating form-floating-outline mb-4 col-6">
              ...
              <label for="thmbnail">Banner Thumbnail</label>
            </div>
            <div class="row">
