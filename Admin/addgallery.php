...
$alert = "";
  ...
  if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO `product_gallery`(`Name`, `Thumbnail`) VALUES ('$name','$thumbnailpath')";
    $run = mysqli_query($connect,$query);

    if (!$run) {
      $alert = "<div class'alert alert-danger'>Gallery not Added</div>";
    } else {
      header("location:managegallery.php");
      $alert = "<div class'alert alert-success'>Gallery Added</div>";
    }
