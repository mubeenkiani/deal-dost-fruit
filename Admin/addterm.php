<?php 
  ...
  if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO `term`(`Term&Condition`) VALUES ('$data')";
    $run = mysqli_query($connect,$query);

    if (!$run) {
      $alert = "<div class'alert alert-danger'>Term & Condition not Added</div>";
    } else {
      header("location:manageterm.php");
      $alert = "<div class'alert alert-success'>Term & Condition Added</div>";
    }
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row mb-4">
              <div class="col-md">
                <div class="card">
                  <h5 class="card-header">Add Term & Condition</h5>
                  <div class="card-body">
                    <form class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                      <?php echo $alert ?>
                      <textarea class="form-control mb-4" id="example" name="editor" rows="10"></textarea>
                      <div>
