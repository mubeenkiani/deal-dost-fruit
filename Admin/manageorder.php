                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    ?>
                        <tr>
                          ...
                          <td><span class="badge rounded-pill bg-label-<?php echo $color ?> me-1"><?php echo $row['order_status'] ?></span></td>
                          <td><?php echo date('d M Y H:i', strtotime($row['created_at'])) ?></td>
                          <td>
                            <div>
                              <a class="" href="editorder.php?Id=<?php echo $row['id'] ?>"><i class="mdi mdi-pencil-outline me-1"></i></a>
