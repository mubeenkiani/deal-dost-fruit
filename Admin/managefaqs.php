...
<?php include 'nav.php' ?><nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar"> 
...
<!-- Product List Table -->
<div class="card">
  <h5 class="card-header">F.A.Qs</h5>
    ...
    <table class="table table-hover">
      ...
      <tbody class="table-border-bottom-0">
        <tr>
          ...
          <td>
            <div>
              <a class="" href="editfaq.php?Id=<?php echo $row['Id'] ?>"><i class="mdi mdi-pencil-outline me-1"></i></a>
              <a onclick="return confirm('Are You Sure')" href="deletefaq.php?Id=<?php echo $row['Id'] ?>"><i class="mdi mdi-trash-can-outline me-1 text-danger"></i></a>
            </div>
          </td>
