                  ...
                  <div class="row gy-4 gy-sm-1">
                    <div class="col-sm-6 col-lg-4">
                      <div
                        ...
                        <div>
                          ...
                          <h4 class="mb-2"><span class="badge rounded-pill bg-label-success">
                              <?php echo $count ?>
                            </span>
                            <h4>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                      <div
                        ...
                        <div>
                          <p class="mb-2">Product InStock</p>
                          <h4 class="mb-2"><span class="badge rounded-pill bg-label-success">
                              <?php echo $count1 ?>
                            </span></h4>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                      <div
                        ...
                        <div>
                          <p class="mb-2">Product Out of Stock</p>
                          <h4 class="mb-2"><span class="badge rounded-pill bg-label-success">
                              <?php echo $count2 ?>
                            </span></h4>
                        </div>
       ...
       ?>
                  <tbody class="table-border-bottom-0">
                    <tr>
                      ...
                      <td><span class="badge rounded-pill bg-label-<?php echo $msge ?> me-1">
                          <?php echo $row['Stock'] ?>
                        </span></td>
                      <td>
                        <div>
                          <a class="" href="editproduct.php?Id=<?php echo $row['Id'] ?>"><i
                              class="mdi mdi-pencil-outline me-1"></i></a>
                          <a onclick="return confirm('Are You Sure')"
                            href="deleteproduct.php?Id=<?php echo $row['Id'] ?>"><i
                              class="mdi mdi-trash-can-outline me-1 text-danger"></i></a>
                        </div>
                      </td>
                    </tr>
                  </tbody>
